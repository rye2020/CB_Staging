<?php
/**
* Template Name: CBAgg_CDN2024
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of CDN issuance from SQL for the year 2024.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Region= 'Canada' AND Date LIKE '%2024%'";
?>
...
<h1 class="t1USDCB">Canadian Covered Bond Issuance 2024</h1>
