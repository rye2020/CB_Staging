<?php
/**
* Template Name: CBAgg_CDN2020
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of CDN issuance from SQL for the year 2020.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Region= 'Canada' AND Date LIKE '%2020%'";
?>
...
<h1 class="t1USDCB">Canadian Covered Bond Issuance 2020</h1>
