<?php
/**
* Template Name: CBAgg_USD2020
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of USD issuance from SQL for the year 2020.
 *
 *
 * @package WordPress
 * @subpackage Twenty_Eleven_Child
 * @ author J.R.Marlatt
 * version 1.0 December 29, 2019
 */

get_header('tables'); ?>

<?php
$like = " WHERE Currency = '$' AND Date LIKE '%2020%'";
?>
<div class="CBTable" id="BuildCBTable" style="width:100%;">
<div class="CBtable-center">
<p style="font-family:'Georgia';font-variant:small-caps; font-size:80%; font-weight:700; margin: 0 0 0 0;">Updated: 12/29/2019</p>
<h1 class="t1USDCB">USD Covered Bond Issuance 2020</h1>
