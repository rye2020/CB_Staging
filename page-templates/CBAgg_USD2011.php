<?php
/**
* Template Name: CBAgg_USD2011
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of USD issuance from SQL for the year 2011.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Currency = '$' AND Date LIKE '%2011%'";
?>
...
<h1 class="t1USDCB">USD Covered Bond Issuance 2011</h1>
