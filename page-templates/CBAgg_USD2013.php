<?php
/**
* Template Name: CBAgg_USD2013
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of USD issuance from SQL for the year 2013.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Currency = '$' AND Date LIKE '%2013%'";
?>
...
<h1 class="t1USDCB">USD Covered Bond Issuance 2013</h1>
