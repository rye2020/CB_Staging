<?php
/**
* Template Name: CBAgg_CDN2018
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of CDN issuance from SQL for the year 2018.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Region= 'Canada' AND Date LIKE '%2018%'";
?>
...
<h1 class="t1USDCB">Canadian Covered Bond Issuance 2018</h1>
