<?php
/**
* Template Name: CBAgg_CDN2017
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of CDN issuance from SQL for the year 2016.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Region= 'Canada' AND Date LIKE '%2017%'";
?>
<div class="CBTable" id="BuildCBTable" style="width:100%;">
<div class="CBtable-center">
<p style="font-family:'Georgia';font-variant:small-caps; font-size:80%; font-weight:700; margin: 0 0 0 0;">Updated: 1/4/2017</p>
<h1 class="t1USDCB">Canadian Covered Bond Issuance 2017</h1>
