<?php
/**
* Template Name: CBAgg_USD2022
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of USD issuance from SQL for the year 2022.
 *
 *
 * @package WordPress
 * @subpackage Twenty_Eleven_Child
 * @ author J.R.Marlatt
 * version 1.0 February 27, 2022
 */

get_header('tables'); ?>

<?php
$like = " WHERE Currency = '$' AND Date LIKE '%2022%'";
?>
...
<h1 class="t1USDCB">USD Covered Bond Issuance 2022</h1>
