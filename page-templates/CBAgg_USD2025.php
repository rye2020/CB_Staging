<?php
/**
* Template Name: CBAgg_USD2025
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of USD issuance from SQL for the year 2025.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Currency = '$' AND Date LIKE '%2025%'";
?>
...
<?php 
		jrm_get_table ('CBAggregate',$like,'yes',6);
?>
</table>
