<?php
/**
* Template Name: CBAgg_CDN2025
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of CDN issuance from SQL for the year 2025.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Region= 'Canada' AND Date LIKE '%2025%'";
?>
<div class="CBTable" id="BuildCBTable" width:100%;">
...
<h1 class="t1USDCB">Canadian Covered Bond Issuance 2025</h1>
