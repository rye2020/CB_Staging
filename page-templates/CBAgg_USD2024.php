<?php
/**
* Template Name: CBAgg_USD2024
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of USD issuance from SQL for the year 2024.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Currency = '$' AND Date LIKE '%2024%'";
?>
<div class="CBTable" id="BuildCBTable" style="width:100%;">
<div class="CBtable-center">
<p style="font-family:'Georgia';font-variant:small-caps; font-size:80%; font-weight:700; margin: 0 0 0 0;">Updated: 12/3/2023</p>
<h1 class="t1USDCB">USD Covered Bond Issuance 2024</h1>
