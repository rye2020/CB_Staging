<?php
/**
* Template Name: CBAgg_USD2023
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of USD issuance from SQL for the year 2023.
 *
 *
 * @package WordPress
 * @subpackage Twenty_Eleven_Child
 * @ author J.R.Marlatt
 * version 1.0 December 17, 2022
 */

get_header('tables'); ?>

<?php
$like = " WHERE Currency = '$' AND Date LIKE '%2023%'";
?>
<div class="CBTable" id="BuildCBTable" style="width:100%;">
<div class="CBtable-center">
<p style="font-family:'Georgia';font-variant:small-caps; font-size:80%; font-weight:700; margin: 0 0 0 0;">Updated: 12/17/2022</p>
<h1 class="t1USDCB">USD Covered Bond Issuance 2023</h1>
