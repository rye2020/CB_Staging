<?php
/**
* Template Name: CBAgg_USD2010
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of USD issuance from SQL for the year 2010.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Currency = '$' AND Date LIKE '%2010%'";
?>
...
<h1 class="t1USDCB">USD Covered Bond Issuance 2010</h1>
