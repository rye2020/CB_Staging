<?php
/**
* Template Name: CBAgg_USD2015
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of USD issuance from SQL for the year 2015.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Currency = '$' AND Date LIKE '%2015%'";
?>
...
<h1 class="t1USDCB">USD Covered Bond Issuance 2015</h1>
