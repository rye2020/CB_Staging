<?php
/**
* Template Name: CBAgg_CDN2019
* Template Post Type: page
 *
 * This is the template that displays the 
 * table of CDN issuance from SQL for the year 2019.
 *
 *
 * @package WordPress
...
<?php
$like = " WHERE Region= 'Canada' AND Date LIKE '%2019%'";
?>
...
<h1 class="t1USDCB">Canadian Covered Bond Issuance 2019</h1>
