...
{
// Load for every page
    wp_enqueue_style('AllPages', get_stylesheet_directory_uri() . '/CSS/allpages.css');    5 Aug test
    wp_enqueue_style('Style', get_stylesheet_directory_uri() . '/style.css');               5 Aug test
