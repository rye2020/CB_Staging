...
<!--<![endif]-->
<head>
		<!--- This is the special header for misc --->
	<?php
	$GLOBALS['header_misc_loaded'] = true;
    ?>
...
<div id="page" class="hfeed">
	<header id="branding" role="banner">
			<hgroup>
				<h1 id="site-title"><span><a href="http://www.us-covered-bonds.com/mtns" rel="home">Capital Markets Offerings</a></span></h1>  
                             
				<h2 id="site-description">The group's capital markets offerings</h2>
			</hgroup>  
			<?php
